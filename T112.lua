...
if game.PlaceId == 14433762945 then
    ...
    for i,v in pairs(WorldDate) do
        if v.WorldNum > -1 and i ~= "Test" then
            ...
            local Enemie = require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("DBZ"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("OnePiece"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("OnePiece2"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("Aot"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("Chainsaw"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("Raids"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("DeathBall"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("MaxDamageChallenge"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("Hub"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("Hub2"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("ShadowWorld"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("Tower"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("Naruto"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("Bleach"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("JJK"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("HxH"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("DemoxSlayer"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("Jojo"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("MHA"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("Special"))
            or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("TutorialHub"))
            ...
            elseif SaveSettings["Raids"]['Auto Farm Raid'] and game:GetService("Workspace").Worlds:FindFirstChild("Raids") then
                ...
                elseif LocalPlayer.PlayerGui.MainGui.HUD.RaidHUD.TimerDisplay.Timer:GetAttribute("EndTime") ~= 0 then
                    if SaveSettings["Raids"]['Auto Farm Raid'] then
                        if SaveSettings["Raids"]['Collect Chest [First Chest Leave]'] and GetRaids("GetChest") ~= "None" then
