            ...
            if SaveSettings["Misc"]['Instant Tp'] then
                table.foreach(CheckPet('GetPet'),function(a,b)
                    if b:FindFirstChild("Target") and b.Target.Value and 
                        if string.find(b.Target.Value.Name,"ArmourTitan") and (b:GetModelCFrame().Position - b.Target.Value:GetPivot().Position).Magnitude > 65 then
                            b:PivotTo(b.Target.Value:GetPivot())
                        elseif string.find(b.Target.Value.Name,"ColossalTitan") and (b:GetModelCFrame().Position - b.Target.Value:GetPivot().Position).Magnitude > 110 then
                            b:PivotTo(b.Target.Value:GetPivot())
