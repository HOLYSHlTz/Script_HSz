            ...
            if v['Count'] > 0 and (v['Count'] - Table_All_Items_Old_data[i]['Count']) > 0 then
                if v['Count Shiny'] and v['Count'] then
                    if v['Count'] > 0 or v['Count Shiny'] > 0 then
                        if v['Count'] > 0 and (v['Count'] - Table_All_Items_Old_data[i]['Count']) > 0 then
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". " .. tostring(v['Name']) .. " : x" .. tostring(v['Count'] - Table_All_Items_Old_data[i]['Count']) .. " [Total : " .. tostring(v['Count'] + (v['Count'] - Table_All_Items_Old_data[i]['Count'])) .. "]"
                            if v['Count Shiny'] > 0 and (v['Count Shiny'] - Table_All_Items_Old_data[i]['Count Shiny']) > 0 then
                                TextDropLabel = TextDropLabel .. " | " .. tostring(v['Name']) .. " (Shiny) : x" .. tostring(v['Count Shiny'] - Table_All_Items_Old_data[i]['Count Shiny']) .. " [Total : " .. tostring(v['Count'] + (v['Count Shiny'] - Table_All_Items_Old_data[i]['Count Shiny'])) .. "]\n"
            ...
            if v['Count'] > 0 and (v['Count'] - Table_All_Items_Old_data[i]['Count']) > 0 then
                ...
                elseif string.find(i,"portal") or string.find(i,"disc") then
                    ...
                    if string.gsub(i, "%D", "") == "" then
                        ...
                        TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". " .. tostring(v['Name']) .. " Tier " .. tostring(string.gsub(i, "%D", "")) .. " : x" .. tostring(v['Count'] - Table_All_Items_Old_data[i]['Count']) .. " [Total : " .. tostring(v['Count'] + (v['Count'] - Table_All_Items_Old_data[i]['Count'])) .. "]\n"
                    end
                    CountAmount = CountAmount + 1
                    else
                        TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". " .. tostring(v['Name']) .. " : x" .. tostring(v['Count'] - Table_All_Items_Old_data[i]['Count']) .. " [Total : " .. tostring(v['Count'] + (v['Count'] - Table_All_Items_Old_data[i]['Count'])) .. "]\n"
...
local UIUPDT = Home:Sector("⚙️ HSz_AA "..version.." ⚙️")
