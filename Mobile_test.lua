...
local UnitAOEU1 = UA:Sector("Unit 1 INF Range ")
local UnitAOEU2 = UA:Sector("Unit 2 INF Range ")
local UnitAOEU3 = UA:Sector("Unit 2 INF Range ")
local UnitAOEU4 = UA:Sector("Unit 2 INF Range ")
local UnitAOEU5 = UA:Sector("Unit 2 INF Range ")
local UnitAOEU6 = UA:Sector("Unit 2 INF Range ")
...
local function AutoFarmSec()
    ...
    AutoFarmConfig:Cheat("Checkbox"," Auto Abilities ใช้สกิล [บัพวน] ", function(bool)
        print(bool)
...
--- End of Fetch Unit
for i = 1, 1 do
UnitAOEU1:Cheat("Dropdown", "เลือก Unit 1",function(value)
    Settings.UnitAOE1 = value
    saveSettings()
end, { options = { "ปิดฟังชั่น", names[i] }, default =Settings.UnitAOE1})
end

for i = 2, 2 do
UnitAOEU2:Cheat("Dropdown", "เลือก Unit 2",function(value)
    Settings.UnitAOE2 = value
    saveSettings()
end, { options = { "ปิดฟังชั่น", names[i] }, default =Settings.UnitAOE2})
end

for i = 3, 3 do
UnitAOEU3:Cheat("Dropdown", "เลือก Unit 3",function(value)
    Settings.UnitAOE3 = value
    saveSettings()
end, { options = { "ปิดฟังชั่น", names[i] }, default =Settings.UnitAOE3})
end

for i = 4, 4 do
UnitAOEU4:Cheat("Dropdown", "เลือก Unit 4",function(value)
    Settings.UnitAOE4 = value
    saveSettings()
end, { options = { "ปิดฟังชั่น", names[i] }, default =Settings.UnitAOE4})
end

for i = 5, 5 do
UnitAOEU5:Cheat("Dropdown", "เลือก Unit 5",function(value)
    Settings.UnitAOE5 = value
    saveSettings()
end, { options = { "ปิดฟังชั่น", names[i] }, default =Settings.UnitAOE5})
end

for i = 6, 6 do
UnitAOEU6:Cheat("Dropdown", "เลือก Unit 6",function(value)
    Settings.UnitAOE6 = value
    saveSettings()
end, { options = { "ปิดฟังชั่น", names[i] }, default =Settings.UnitAOE6})
end
