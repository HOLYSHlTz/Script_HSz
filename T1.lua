                    ...
                    if SaveSettings["Raids"]['Auto Farm Raid'] then
                        ...
                        elseif game:GetService("Workspace").Worlds:FindFirstChild("Raids")[FindRaids(game.Players.LocalPlayer.Character.HumanoidRootPart)]:GetAttribute("RaidId") == 'OnePiece2Raid' then
                            if SaveSettings["Raids"]['Auto Farm Raid'] and GetRaids("GetZone").ZoneNow == "Zone5" and GetRaids("GetZone").ZoneNext == "Zone6" and GetRaids("GetCountMon") == 0 then
                                wait(.5)
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(6281.85742, -135.227661, 12224.6855, -0.309872389, 0, -0.950778127, 0, 1, 0, 0.950778127, 0, -0.309872389)
