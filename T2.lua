...
if game.PlaceId == 14433762945 then
    ...
    function SendPetAllTraget(PetTraget,Mobs)
        local TragetMonster = Mobs
        local PetTraget = PetTraget
        ReplicatedStorage.Bindable.Pets.SendAllPets:Fire(PetTraget,TragetMonster);
    end
