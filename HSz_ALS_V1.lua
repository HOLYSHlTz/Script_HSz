                    ...
                    ["embeds"] = {
                        {
                            ...
                            ["fields"] = {
                                ...
                                {
                                    ["name"] = "Unit Stats :",
                                    ["value"] = testINI .."ini\n" .. TextUnitKills .. testINI,
                                    ["inline"] = false
                                },
                                {
                                    ["name"] = "Player Item Counts :",
                                    ["value"] = testINI .."ini\n" .. TextDropLabelAll .. testINI,
                                    ["inline"] = false
                                },
                            },
                        }
                    ...
                    if v:IsA("Frame") then
                        ...
                        elseif v.MainText.Text ~= "" then
                            ...
                            elseif v.Text.Text == "StrawHat" or v.Text.Text == "Straw Hat" then 
                                ...
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Candy" or v.Text.Text == "Candy" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Candy + 1  <:Candy:1227137395686899723>\n"
                                CountAmount = CountAmount + 1
                            else
                    ...
                    ["embeds"] = {
                        {
                            ["title"] = "**Anime Last Stand **:",
                            ["author"] = {
                                ["name"] = "HolyShz Webhook - Anime Last Stand | Method 2 ",
                                ["icon_url"] = "https://tr.rbxcdn.com/4ea4281ed356c343bbecb671936d22cc/150/150/Image/Png",
                            },
                            ["image"] = {
                                ["url"] = "https://tr.rbxcdn.com/e893b8fc4ca334bdf84d9ae82e277667/768/432/Image/Png",
    ...
    spawn(function()
        while wait() do
            if SaveSettings["SaveSetting"]['Auto TP to Zone'] and game.PlaceId ~= 12886143095 then
                ...
                local Random_Num_x = math.random(1,30)
                local Random_Num_z = math.random(1,30)
                ...
                if MapDataTabel.MapName  == "Desert Village" then
                    if HumanoidRootPart.CFrame ~= "-127.22598266601562, 199.55479431152344, 16.245275497436523" then
                        ClickToMoveController:MoveTo(Vector3.new(-127.22598266601562 + tonumber(Num_Up), 199.55479431152344, 16.245275497436523 + tonumber(Num_Down)))
                        wait(180)
                        ClickToMoveController:MoveTo(Vector3.new(-127.22598266601562 - tonumber(final_num_x), 199.55479431152344, 16.245275497436523 - tonumber(final_num_z)))
                        wait(360)
                        ClickToMoveController:MoveTo(Vector3.new(-127.22598266601562 + tonumber(final_num_x), 199.55479431152344, 16.245275497436523 + tonumber(final_num_z)))
                        wait(540)
                        ClickToMoveController:MoveTo(Vector3.new(-127.22598266601562 - tonumber(final_num_x), 199.55479431152344, 16.245275497436523 - tonumber(final_num_z)))
                ...
                elseif MapDataTabel.MapName  == "Water Park" then
                    if HumanoidRootPart.CFrame ~= "-116.39897918701172, 254.02249145507812, 77.78429412841797" then 
                        ClickToMoveController:MoveTo(Vector3.new(-116.39897918701172 + tonumber(Num_Up), 254.02249145507812, 77.78429412841797 + tonumber(Num_Down)))
                        wait(180)
                        ClickToMoveController:MoveTo(Vector3.new(-116.39897918701172 - tonumber(final_num_x), 254.02249145507812, 77.78429412841797 - tonumber(final_num_z)))
                        wait(360)
                        ClickToMoveController:MoveTo(Vector3.new(-116.39897918701172 + tonumber(final_num_x_New), 254.02249145507812, 77.78429412841797 + tonumber(final_num_z)))
                        wait(540)
                        ClickToMoveController:MoveTo(Vector3.new(-116.39897918701172 - tonumber(final_num_x), 254.02249145507812, 77.78429412841797 - tonumber(final_num_z)))
                    else
                        ClickToMoveController:MoveTo(Vector3.new(-116.39897918701172 + tonumber(final_num_x), 254.02249145507812, 77.78429412841797 - tonumber(final_num_z)))
                ...
                elseif MapDataTabel.MapName  == "Hollow Dimension" then
                    if HumanoidRootPart.CFrame ~= "-125.69774627685547, 115.45217895507812, 4.159978866577148" then
                        ClickToMoveController:MoveTo(Vector3.new(-125.69774627685547 + tonumber(Num_Up), 115.45217895507812, 4.159978866577148 + tonumber(Num_Down)))
                        wait(180)
                        ClickToMoveController:MoveTo(Vector3.new(-125.69774627685547 - tonumber(final_num_x), 115.45217895507812, 4.159978866577148 - tonumber(final_num_z)))
                        wait(360)
                        ClickToMoveController:MoveTo(Vector3.new(-125.69774627685547 + tonumber(final_num_x_New), 115.45217895507812, 4.159978866577148 + tonumber(final_num_z)))
                        wait(540)
                        ClickToMoveController:MoveTo(Vector3.new(-125.69774627685547 - tonumber(final_num_x), 115.45217895507812, 4.159978866577148 - tonumber(final_num_z)))
                    else
                        ClickToMoveController:MoveTo(Vector3.new(-125.69774627685547 + tonumber(final_num_x), 115.45217895507812, 4.159978866577148 - tonumber(final_num_z)))
                ...
                elseif MapDataTabel.MapName  == "Planet Nemak" then
                    if HumanoidRootPart.CFrame ~= "-194.38824462890625, 24.020198822021484, 47.92061233520508" then
                        ClickToMoveController:MoveTo(Vector3.new(-194.38824462890625 + tonumber(Num_Up), 24.020198822021484, 47.92061233520508 + tonumber(Num_Down)))
                        wait(180)
                        ClickToMoveController:MoveTo(Vector3.new(-194.38824462890625 - tonumber(final_num_x), 24.020198822021484, 47.92061233520508 - tonumber(final_num_z)))
                        wait(360)
                        ClickToMoveController:MoveTo(Vector3.new(-194.38824462890625 + tonumber(final_num_x), 24.020198822021484, 47.92061233520508 + tonumber(final_num_z)))
                        wait(540)
                        ClickToMoveController:MoveTo(Vector3.new(-194.38824462890625 - tonumber(final_num_x), 24.020198822021484, 47.92061233520508 - tonumber(final_num_z)))
                ...
                elseif MapDataTabel.MapName  == "Star Mansion" then
                    if HumanoidRootPart.CFrame ~= "-152.55552673339844, 22.699983596801758, -73.82027435302734" then
                        ClickToMoveController:MoveTo(Vector3.new(-152.55552673339844 + tonumber(Num_Up), 22.699983596801758, -73.82027435302734 + tonumber(Num_Down)))
                        wait(180)
                        ClickToMoveController:MoveTo(Vector3.new(-152.55552673339844 - tonumber(final_num_x), 22.699983596801758, -73.82027435302734 - tonumber(final_num_z)))
                        wait(360)
                        ClickToMoveController:MoveTo(Vector3.new(-152.55552673339844 + tonumber(final_num_x), 22.699983596801758, -73.82027435302734 + tonumber(final_num_z)))
                        wait(540)
                        ClickToMoveController:MoveTo(Vector3.new(-152.55552673339844 - tonumber(final_num_x), 22.699983596801758, -73.82027435302734 - tonumber(final_num_z)))
                ...
                elseif MapDataTabel.MapName  == "Marines Fort" then
                    if HumanoidRootPart.CFrame ~= "-1152.418212890625, 396.64385986328125, -10.058626174926758" then
                        ClickToMoveController:MoveTo(Vector3.new(-1152.418212890625 + tonumber(Num_Up), 396.64385986328125, -10.058626174926758 + tonumber(Num_Down)))
                        wait(180)
                        ClickToMoveController:MoveTo(Vector3.new(-1152.418212890625 - tonumber(final_num_x), 396.64385986328125, -10.058626174926758 - tonumber(final_num_z)))
                        wait(360)
                        ClickToMoveController:MoveTo(Vector3.new(-1152.418212890625 + tonumber(final_num_x), 396.64385986328125, -10.058626174926758 + tonumber(final_num_z)))
                        wait(540)
                        ClickToMoveController:MoveTo(Vector3.new(-1152.418212890625 - tonumber(final_num_x), 396.64385986328125, -10.058626174926758 - tonumber(final_num_z)))
