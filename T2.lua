...
if game.PlaceId == 14433762945 then
    ...
    local UI = Venyx.new({
        ...
        Version = "Version 1.0.833.5-TEST"
    })
    ...
    spawn(function()
        while wait() do
            ...
            elseif SaveSettings["Raids"]['Auto Farm Raid'] and game:GetService("Workspace").Worlds:FindFirstChild("Raids") then
                ...
                elseif LocalPlayer.PlayerGui.MainGui.HUD.RaidHUD.TimerDisplay.Timer:GetAttribute("EndTime") ~= 0 and GetRaids("GetChest") ~= "None" then
