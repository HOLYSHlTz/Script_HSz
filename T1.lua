...
--fixmap fixportal
    getgenv().updateworld = function()
        ...
        elseif Settings.WorldCategory == "Dungeon" then
            storylist = {"ดันนิ้ว Cursed Womb","ดันเกะโท Crused Parade","Halloween Event"--[["Anniversary Island"]]}
...
function PlacePos(map,name,_uuid,unit)
    if Settings.AutoFarm and not getgenv().disableatuofarm then
        ...
        --halloween_event
        if map == "namek_halloween" and map2 == "namek_halloween" then map = "namek" end
        if map == "namek_halloween" and map2 == "aot_halloween" then map = "aot" end
        if map == "namek_halloween" and map2 == "demonslayer_halloween" then map = "demonslayer" end
        if map == "namek_halloween" and map2 == "naruto_halloween" then map = "naruto_desert" end
        if map == "namek_halloween" and map2 == "marineford_halloween" then map = "marineford" end
