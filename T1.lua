...
function webhook()
    if Settings.WebhookEnabled then
        ...
        local thumbnails_avatar = HttpService:JSONDecode(game:HttpGet("https://www.roblox.com/headshot-thumbnail/image?userId=" .. game:GetService("Players").LocalPlayer.UserId .. "&size=150x150&format=Png&isCircular=true", true))
