...
local function decompiles(scriptPath: Script | ModuleScript | LocalScript): string
    return call("/konstant/decompile", scriptPath)
end

local function disassembles(scriptPath: Script | ModuleScript | LocalScript): string
...
local function main()
	...
	ScriptViewer.ViewScript = function(scr)
		local success, source = pcall(decompiles or function() end, scr)
