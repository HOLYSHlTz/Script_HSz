                ...
                if v:FindFirstChild("_stats") then
    				...
    				elseif v._stats:FindFirstChild("player") then
                        ...
                        local NameSkill = {}
                            ...
                            --Auto_Skill--
                            --Boss_Wave
                            local S_wave0 = game:GetService("Workspace"):WaitForChild("_wave_num")
                            ...
                            if v._stats.id.Value ~= "erwin" and v._stats.id.Value ~= "wendy" and v._stats.id.Value ~= "leafa" and v._stats.id.Value ~= "aot_generic" then
                                if v._stats.active_attack.Value ~= "nil" and tonumber(Settings.AutoSkillWave) <= S_wave0.Value then
                                    if Settings.SelectedSkillUse2 == "bosswave" then
                                        -- Check Infinite
                            ...
                            --When_Attack
                            local S_wave1 = game:GetService("Workspace"):WaitForChild("_wave_num")
                            if v._stats.id.Value ~= "erwin" and v._stats.id.Value ~= "wendy" and v._stats.id.Value ~= "leafa" and v._stats.id.Value ~= "aot_generic" then
                                if Settings.SelectedSkillUse2 == "whenattack" then
                                if v._stats.state.Value == "attack" then
                                    if v._stats.active_attack.Value ~= "nil" and tonumber(Settings.AutoSkillWave) <= S_wave1.Value then
                                        wait(2)
                                        game:GetService("ReplicatedStorage").endpoints.client_to_server.use_active_attack:InvokeServer(v)
                            ...
                            --Golbal_Cooldown
                            local S_wave2 = game:GetService("Workspace"):WaitForChild("_wave_num")
                            if v._stats.id.Value ~= "erwin" and v._stats.id.Value ~= "wendy" and v._stats.id.Value ~= "leafa" and v._stats.id.Value ~= "aot_generic" then
                                    if Settings.SelectedSkillUse2 == "Information" then
                                    if v._stats.state.Value == "formation" then
                                        if v._stats.active_attack.Value ~= "nil" and tonumber(Settings.AutoSkillWave) <= S_wave2.Value then
                                            game:GetService("ReplicatedStorage").endpoints.client_to_server.use_active_attack:InvokeServer(v)
                                            warn("Use Skill : " ..tostring(v._stats.id.Value) .. " | Method : "  ..tostring(NameSkill) .. " | Wave : " ..tostring(GetWaveNumber()))
                                        end
                                    end
                            ...
                            --Boss_Distance
                            --checkUnitDistance
                            local S_wave19 = game:GetService("Workspace"):WaitForChild("_wave_num")
                            local RYY2 = game.Players.LocalPlayer.Name
                            for i, v in ipairs(game:GetService("Workspace")["_UNITS"]:GetChildren()) do
                                if v:WaitForChild("_stats"):FindFirstChild("base") then
                                    if tostring(v._stats.base.Value) == "pve" then
                            ...
                            if v._stats.id.Value ~= "erwin" and v._stats.id.Value ~= "wendy" and v._stats.id.Value ~= "leafa" and v._stats.id.Value ~= "aot_generic" then
                                if v._stats.active_attack.Value ~= "nil" and tonumber(Settings.AutoSkillWave) <= S_wave19.Value then
                                    if Settings.SelectedSkillUse2 == "BossDistance" then
                                        -- Check Infinite
                                        if GLD()._gamemode == "infinite" then
                                ...
                                --GBCD_Distance
                                --checkUnitDistance
                                local S_wave3 = game:GetService("Workspace"):WaitForChild("_wave_num")
                                local RYY2 = game.Players.LocalPlayer.Name
                                for i, v in ipairs(game:GetService("Workspace")["_UNITS"]:GetChildren()) do
                                    if v:WaitForChild("_stats"):FindFirstChild("base") then
                                        if tostring(v._stats.base.Value) == "pve" then
                                ...
                                for i, v in ipairs(game:GetService("Workspace")["_UNITS"]:GetChildren()) do
                                    if tostring(v["_stats"].player.Value) == RYY3 then
                                        ...
                                        if v._stats.id.Value ~= "erwin" and v._stats.id.Value ~= "wendy" and v._stats.id.Value ~= "leafa" and v._stats.id.Value ~= "aot_generic" then
                                            if v._stats.active_attack.Value ~= "nil" and tonumber(Settings.AutoSkillWave) <= S_wave3.Value then
                                                if Settings.SelectedSkillUse2 == "GBCDDistance" then 
                                                    if v._stats.state.Value == "formation" then
                                                    if tonumber(Settings.UnitDistanceX) >= distanceU then
                                                        if tonumber(Settings.AutoSkillWave) <= S_wave5.Value and tonumber(Settings.UnitDistanceX) > tostring(string.format('%d', distanceU)) or tostring(string.format('%d', distanceU)) < tonumber(Settings.UnitDistanceX) then
                                                        game:GetService("ReplicatedStorage").endpoints.client_to_server.use_active_attack:InvokeServer(v)
                                ...
                                --Attack_Distance
                                --checkUnitDistance
                                local S_wave4 = game:GetService("Workspace"):WaitForChild("_wave_num")
                                local RYY2 = game.Players.LocalPlayer.Name
                                for i, v in ipairs(game:GetService("Workspace")["_UNITS"]:GetChildren()) do
                                    if v:WaitForChild("_stats"):FindFirstChild("base") then
                                        if tostring(v._stats.base.Value) == "pve" then
                                ...
                                for i, v in ipairs(game:GetService("Workspace")["_UNITS"]:GetChildren()) do
                                    if tostring(v["_stats"].player.Value) == RYY3 then
                                        ...
                                        if v._stats.id.Value ~= "erwin" and v._stats.id.Value ~= "wendy" and v._stats.id.Value ~= "leafa" and v._stats.id.Value ~= "aot_generic" then
                                            if v._stats.active_attack.Value ~= "nil" and tonumber(Settings.AutoSkillWave) <= S_wave4.Value then
                                                if Settings.SelectedSkillUse2 == "ATKDistance" then 
                                                    if v._stats.state.Value == "attack" then
                                                    if tonumber(Settings.UnitDistanceX) >= distanceU then
                                                        if tonumber(Settings.AutoSkillWave) <= S_wave5.Value and tonumber(Settings.UnitDistanceX) > tostring(string.format('%d', distanceU)) or tostring(string.format('%d', distanceU)) < tonumber(Settings.UnitDistanceX) then
                                ...
                                --Distance
                                --checkUnitDistance
                                local S_wave5 = game:GetService("Workspace"):WaitForChild("_wave_num")
                                local RYY2 = game.Players.LocalPlayer.Name
                                for i, v in ipairs(game:GetService("Workspace")["_UNITS"]:GetChildren()) do
                                    if v:WaitForChild("_stats"):FindFirstChild("base") then
                                        if tostring(v._stats.base.Value) == "pve" then
