...
if game.PlaceId == 14433762945 then
    ...
    _G.NoClip = game:GetService("RunService").Heartbeat:Connect(function()
        ...
        elseif tostring(TimeRaidMain) <= "0:00" or tostring(TimeRaidMain) >= "4:56" and game:GetService("Workspace").Worlds:FindFirstChild("Hub") and CountTimeRaids then
            if SaveSettings["Raids"]['Auto Farm Raid'] then
