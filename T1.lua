                                        ...
                                        if v._stats.id.Value ~= "erwin" and v._stats.id.Value ~= "wendy" and v._stats.id.Value ~= "leafa" and v._stats.id.Value ~= "aot_generic" then
                                            if v._stats.active_attack.Value ~= "nil" then
                                                if Settings.SelectedSkillUse2 == "GBCDDistance" and tonumber(Settings.AutoSkillWave) <= S_wave.Value then 
                                                    ...
                                                    if tostring(Settings.UnitDistanceX) >= tostring(string.format('%d', distanceU3)) or tostring(string.format('%d', distanceU3)) <= tostring(Settings.UnitDistanceX) then
                                                        game:GetService("ReplicatedStorage").endpoints.client_to_server.use_active_attack:InvokeServer(v)
                                        ...
                                        if v._stats.id.Value ~= "erwin" and v._stats.id.Value ~= "wendy" and v._stats.id.Value ~= "leafa" and v._stats.id.Value ~= "aot_generic" then
                                            if v._stats.active_attack.Value ~= "nil" then
                                                if Settings.SelectedSkillUse2 == "ATKDistance" and tonumber(Settings.AutoSkillWave) <= S_wave.Value then 
                                                    ...
                                                    if tostring(Settings.UnitDistanceX) >= tostring(string.format('%d', distanceU5)) or tostring(string.format('%d', distanceU5)) <= tostring(Settings.UnitDistanceX) then
                                                        wait(1.5)
                                                        game:GetService("ReplicatedStorage").endpoints.client_to_server.use_active_attack:InvokeServer(v)
                                        ...
                                        if v._stats.id.Value ~= "erwin" and v._stats.id.Value ~= "wendy" and v._stats.id.Value ~= "leafa" and v._stats.id.Value ~= "aot_generic" then
                                            if v._stats.active_attack.Value ~= "nil" then
                                                if Settings.SelectedSkillUse2 == "distanceCount" and tonumber(Settings.AutoSkillWave) <= S_wave.Value then 
                                                    if tostring(Settings.UnitDistanceX) >= tostring(string.format('%d', distanceU2)) or tostring(string.format('%d', distanceU2)) <= tostring(Settings.UnitDistanceX) then
                                                        wait(1.5)
                                                        game:GetService("ReplicatedStorage").endpoints.client_to_server.use_active_attack:InvokeServer(v)
