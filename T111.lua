                ...
                elseif LocalPlayer.PlayerGui.MainGui.HUD.RaidHUD.TimerDisplay.Timer:GetAttribute("EndTime") ~= 0 then
                    if SaveSettings["Raids"]['Auto Farm Raid'] then
                        ...
                        elseif game:GetService("Workspace").Worlds:FindFirstChild("Raids") then
                            if game:GetService("Workspace").Worlds:FindFirstChild("Raids")[FindRaids(game.Players.LocalPlayer.Character.HumanoidRootPart)]:GetAttribute("RaidId") == 'HxHRaid' and SaveSettings["Raids"]['Auto Farm Raid'] and GetRaids("GetZone").ZoneNow == "Zone8" and GetRaids("GetZone").ZoneNext == "Zone9" and GetRaids("GetCountMon") == 0 then
                                ...
                                repeat wait() until not LocalPlayer.PlayerGui:FindFirstChild('TeleportGui')
                            elseif game:GetService("Workspace").Worlds:FindFirstChild("Raids")[FindRaids(game.Players.LocalPlayer.Character.HumanoidRootPart)]:GetAttribute("RaidId") == 'OnePiece2Raid' and SaveSettings["Raids"]['Auto Farm Raid'] and GetRaids("GetZone").ZoneNow == "Zone5" and GetRaids("GetZone").ZoneNext == "Zone6" and GetRaids("GetCountMon") == 0 then
                                local ohString1 = "Raids"
                                local ohString2 = "Palace"
                                game:GetService("ReplicatedStorage").Remote.Player.Teleport:FireServer(ohString1, ohString2)
                                repeat wait() until not LocalPlayer.PlayerGui:FindFirstChild('TeleportGui')
