...
if game.PlaceId == 14433762945 then
    ...
    for i,v in pairs(WorldDate) do
        if v.WorldNum > -1 and i ~= "Test" then
            ...
            local Enemie = require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild("OnePiece2")) or require(ReplicatedStorage.ModuleScripts.Config.EnemyStats:FindFirstChild(i))
