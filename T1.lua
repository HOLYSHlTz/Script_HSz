                    ...
                    if b:FindFirstChild("Target") and b.Target.Value then
                        if string.find(tostring(b.Target.Value),"ColossalTitan") and game:GetService("Workspace").Worlds:FindFirstChild("Raids") then else
                            if string.find(tostring(b.Target.Value),"ArmourTitan") and (b:GetModelCFrame().Position - b.Target.Value:GetPivot().Position).Magnitude > 65 then
                                b:PivotTo(b.Target.Value:GetPivot() * CFrame.new(0,-15,5))
                            elseif string.find(tostring(b.Target.Value),"ColossalTitan") and (b:GetModelCFrame().Position - b.Target.Value:GetPivot().Position).Magnitude > 110 then
                                b:PivotTo(b.Target.Value:GetPivot() * CFrame.new(0,-30,5))
                            elseif (b:GetModelCFrame().Position - b.Target.Value:GetPivot().Position).Magnitude > 30 then--and not string.find(tostring(b.Target.Value),"ColossalTitan") then
